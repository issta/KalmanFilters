/** \file
**
** \brief Define 6x6 matrices of type double and functions to operate on them
** 
** $Id: matrix6x6d.h 1.1 2008/05/21 15:00:22EDT dcmccomas Exp  $
**
** \note
**  -# The matrix is represented as a 6x6 matrix of doubles with
...
#ifndef     _matrix6x6d_h
#define     _matrix6x6d_h
