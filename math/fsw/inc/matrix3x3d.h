/** \file
**
** \brief Define 3x3 matrices of type double and functions to operate on them
**
** $Id: matrix3x3d.h 1.2 2008/09/10 10:00:33EDT gwelter Exp  $
**
** \note
**   -# The matrix is represented as a 3x3 matrix of doubles with
**      subcripts beginning at 0.
**   -# Defining type Matrix3x3d allows compile-time type checking
...
#ifndef     _matrix3x3d_h
#define     _matrix3x3d_h
