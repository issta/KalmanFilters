/** \file
** 
** \brief Define unbounded two dimensioned (MxN) matrices of type double and
**        functions to operate on them
**
** $Id: matrixmxnd.h 1.1 2008/05/21 15:00:22EDT dcmccomas Exp  $
**
** \note
**   -# The matrix is represented as a MxN matrix of doubles with
...
#ifndef     _matrixMxNd_h
#define     _matrixMxNd_h
